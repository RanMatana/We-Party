export default class place {
    constructor(Place_ID, Name_Place, Address_Place, Navigation_Place, Area, Latitude_Place, Longitude_Place, About_Place, Image_Url, Cover_Image, Likes_Place) {

        this.Place_ID = Place_ID;
        this.Name_Place = Name_Place;
        this.Address_Place = Address_Place;
        this.Navigation_Place = Navigation_Place;
        this.Area = Area;
